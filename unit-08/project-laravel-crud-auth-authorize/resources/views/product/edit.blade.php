...
@section('main')
    <main class="container-fluid mx-md-0">
        ...
        <form method="post" action="{{ route('product.update', $prod) }}" enctype="multipart/form-data">
            @method('PATCH')
            @csrf
            <div class="my-md-4">
                <div class="my-md-2">
                    <label for="name" class="form-label">{{__('Nombre del producto')}}</label>
                    <input id="name" class="form-control" name="name" type="text" value="{{old('name', $prod->name)}}"
                           placeholder="{{__('Escribe el nombre del nuevo producto.')}}">
                </div>
            ...
            <div class="my-md-4 form-floating">
                <div class="my-md-2">
                    <textarea id="description" class="form-control" name="description" type="text"
                              placeholder="{{__('Escribe la descripción del nuevo producto.')}}">{{old('description', $prod->description)}}</textarea>
                    <label for="description" class="form-label">{{__('Descripción del producto')}}</label>
                </div>
            ...
            <div class="my-md-4">
                <div class="my-md-2">
                    ...
                    <input id="photo" class="form-control" name="photo" type="file" value="{{old('photo', $prod->photo)}}"
            ...
            <div class="my-md-4">
                <div class="my-md-2">
                    <label for="trademark_name" class="form-label">{{__('Nombre de la marca del producto')}}</label>
                    <input id="trademark_name" class="form-control" name="trademark_name" type="text"
                           value="{{old('trademark_name', $prod->trademark_name)}}"
                           placeholder="{{__('Escribe el nombre de la marca del nuevo producto.')}}">
                </div>
            ...
            <div class="my-md-4">
                <div class="my-md-2">
                    ...
                    <input id="trademark_email" class="form-control" name="trademark_email" type="email"
                           value="{{old('trademark_email', $prod->trademark_email)}}"
            ...
            <div class="my-md-4">
                <div class="my-md-2">
                    <label for="date_expiry" class="form-label">{{__('Fecha de caducidad del producto')}}</label>
                    <input id="trademark_email" class="form-control" name="date_expiry" type="date"
                           value="{{old('date_expiry', $prod->date_expiry)}}">
                </div>
                ...
                <div class="my-md-2">
                    ...
                    <div class="form-check form-check-inline">
                        <input id="type_stock_1" class="form-check-input" type="radio" name="type_stock"
                               @if (old('type_stock', $prod->type_stock) === 'sanitario') checked
                               @endif value="sanitario">
                    ...
                    <div class="form-check form-check-inline">
                        <input id="type_stock_2" class="form-check-input" type="radio" name="type_stock"
                               @if (old('type_stock', $prod->type_stock) === 'no_sanitario') checked
                               @endif value="no_sanitario">
                    ...
                    <div class="form-check form-check-inline">
                        <input id="type_stock_3" class="form-check-input" type="radio" name="type_stock"
                               @if (old('type_stock', $prod->type_stock) === 'alimentario') checked
                               @endif value="alimentario">
            ...
            <div class="my-md-4">
                <div class="my-md-2">
                    <label for="available_stock" class="form-label">{{__('Numero de existencias del producto disponibles')}}</label>
                    <input id="available_stock" name="available_stock" class="form-control" type="number" placeholder="{{__('Escribe el numero de existencias del producto disponibles')}}"
                           value="{{old('available_stock', $prod->available_stock)}}">
                </div>
            ...
            <div class="my-md-4">
                <div class="my-md-2">
                    ...
                    <input id="minimum_stock" name="minimum_stock" class="form-control" type="number" placeholder="{{__('Escribe el numero de existencias del producto mínimas')}}"
                           value="{{old('minimum_stock', $prod->minimum_stock)}}">
                </div>
                    ...
                    <select id="type_product_unit" class="form-select" size="4" name='type_product_unit'
                        ...
                        <optgroup label="{{__('Masa')}}">
                            <option value="kilogramos"
                                    @if (old('type_product_unit', $prod->type_product_unit) === 'kilogramos') selected @endif>{{__('kilogramo/s')}}</option>
                            <option value="hectogramos"
                                    @if (old('type_product_unit', $prod->type_product_unit) === 'hectogramos') selected @endif>{{__('hectogramo/s')}}</option>
                            <option value="decagramos"
                                    @if (old('type_product_unit', $prod->type_product_unit) === 'decagramos') selected @endif>{{__('decagramo/s')}}</option>
                            <option value="gramos"
                                    @if (old('type_product_unit', $prod->type_product_unit) === 'gramos') selected @endif>{{__('gramo/s')}}</option>
                            <option value="decigramos"
                                    @if (old('type_product_unit', $prod->type_product_unit) === 'decigramos') selected @endif>{{__('decigramo/s')}}</option>
                            <option value="centigramos"
                                    @if (old('type_product_unit', $prod->type_product_unit) === 'centigramos') selected @endif>{{__('centigramo/s')}}</option>
                            <option value="miligramos"
                                    @if (old('type_product_unit', $prod->type_product_unit) === 'miligramos') selected @endif>{{__('miligramo/s')}}</option>
                        </optgroup>
                        <optgroup label="{{__('Volumen')}}">
                            <option value="kilolitros"
                                    @if (old('type_product_unit', $prod->type_product_unit) === 'kilolitros') selected @endif>{{__('kilolitro/s')}}</option>
                            <option value="hectolitros"
                                    @if (old('type_product_unit', $prod->type_product_unit) === 'hectolitros') selected @endif>{{__('hectolitro/s')}}</option>
                            <option value="decalitros"
                                    @if (old('type_product_unit', $prod->type_product_unit) === 'decalitros') selected @endif>{{__('decalitro/s')}}</option>
                            <option value="litros"
                                    @if (old('type_product_unit', $prod->type_product_unit) === 'litros') selected @endif>{{__('litro/s')}}</option>
                            <option value="decilitros"
                                    @if (old('type_product_unit', $prod->type_product_unit) === 'decilitros') selected @endif>{{__('decilitro/s')}}</option>
                            <option value="centilitros"
                                    @if (old('type_product_unit', $prod->type_product_unit) === 'centilitros') selected @endif>{{__('centilitro/s')}}</option>
                            <option value="mililitros"
                                    @if (old('type_product_unit', $prod->type_product_unit) === 'mililitros') selected @endif>{{__('mililitro/s')}}</option>
                        </optgroup>
                        <option value="unidades"
                                @if (old('type_product_unit', $prod->type_product_unit) === 'unidades') selected @endif>{{__('unidad/es')}}</option>
                    </select>
                </div>
            ...
            <div class="my-md-4">
                <input type="submit" class="btn btn-dark" value="{{__('Actualizar producto')}}">
            </div>
        </form>
    </main>
@endsection

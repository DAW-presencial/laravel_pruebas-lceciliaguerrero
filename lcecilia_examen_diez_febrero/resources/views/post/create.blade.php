        ...
        <form method="post" action="{{ route('post.store') }}" enctype="multipart/form-data">
            ...
            <div class="my-md-4">
                <div class="my-md-2">
                    ...
                    <input id="name" class="form-control" type="text" name="titulo" value="{{old('titulo')}}"
            ...
            <div class="my-md-4">
                <div class="my-md-2 form-floating">
                    <textarea id="description" class="form-control" type="text" name="extracto"
                              placeholder="{{__('Escribe el extracto.')}}">{{old('extracto')}}</textarea>
            ...
            <div class="my-md-4">
                <div class="my-md-2 form-floating">
                    <textarea id="description2" class="form-control" type="text" name="contenido"
                              placeholder="{{__('Escribe el contenido.')}}">{{old('contenido')}}</textarea>
            ...
            <div class="my-md-4">
                <div class="my-md-2">
                    ...
                    <select id="type_product_unit" class="form-select" size="4" name='acceso'
                        ...
                        <option value="publico" @if (old('acceso') === 'publico') selected @endif>{{__('publico')}}</option>
                        <option value="privado" @if (old('acceso') === 'privado') selected @endif>{{__('privado')}}</option>
                    </select>
                </div>
            ...
            <div class="my-md-4">
                <input type="submit" class="btn btn-dark" value="{{__('productos.Añadir post')}}">
            </div>
        </form>
    </main>
